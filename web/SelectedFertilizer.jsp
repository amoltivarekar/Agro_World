    ...
    <body>
        ...
        <div class="header">
            ...
            <div class="vegitables">
                <center>
                    <h3 style="color: #DCC092;">YOUR SELECTED FERTILIZERS ARE </h3><br><br>
                    <table width="50%">
                        <%!
                        ...
                        <%
                            ...
                            String[] names = request.getParameterValues("fertilizername");
                            List list = Arrays.asList(names);
                            for (int i = 0; i < list.size(); i++) 
                            {
                                pst = con.prepareStatement("select Frname,Frprice from Fertilizer where Frname='" + list.get(i) + "'");
                                rs = pst.executeQuery();
                                while (rs.next())
                                {
                                    %>
