...
<%
    try
    {
        ...
        pst=con.prepareStatement("select adminname,emailid,address,mobno,username,password from agroadmin");
        rs=pst.executeQuery();
        rs.next();
    }
    catch(Exception e)
	...
	<div class="container">
		...
		<div class="top-nav">
			<span class="menu"><img src="images/menu.png" alt=""> </span>
				<ul>
                                        <li class="active"><a href="admprofile.jsp"><%=sur%></a></li>
			...
			<div class="sign-in-htm">
				...
				<div class="group">
					<label for="user" class="label">Full Name</label>
                                        <input name="user" type="text" class="input" value="<% out.print(rs.getString(1));%>" onkeypress="return validateFm(event)" required>
				</div>
				<div class="group">
				...
				<div class="group">
					...
					<label for="pass" class="label">Mobile No</label>
                                        <input name="mobno" type="text" class="input" value="<% out.print(rs.getString(4));%>" onkeypress="return validatephno(event)" required>
				</div>
                                <div class="group">
