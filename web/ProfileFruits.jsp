...
<%
    try
    {
        ...
        pst=con.prepareStatement("select * from fruits order by fname");
        rs=pst.executeQuery();
    }
    catch(Exception e)
    {
			...
			<span class="menu"><img src="images/menu.png" alt=""> </span>
				<ul>
					...
					<li><a href="ProfileVegitabels.jsp">VEGETABLES</a></li>
                                        <li class="active"><a href="ProfileFruits.jsp" >FRUITS</a></li>
...
<div class="vegitables">
    <%int i=1;
    while(rs.next()){%>
    <form action="SelectedFruits.jsp" method="post">
        <div class="vimag" style="padding:10px 300px 0px 50px;">
            <img src="images/F-<%out.print(i);%>.jpg" width="180px" height="150px" id="imgid" >
        </div>
        ...
        </div><input type="checkbox" name="fruitsname" value="<%=rs.getString(1)%>" style="
      width: 28px;
      height: 28px;
      background: #fcfff4;
