    ...
    <body>
        ...
        <div class="header">
            ...
            <div class="vegitables">
                <center>
                    <h3 style="color: #DCC092;">YOUR SELECTED FRUITS ARE </h3><br><br>
                    <table width="50%">
                        ...
                        <%
                            ...
                            String[] names = request.getParameterValues("fruitsname");
                            List list = Arrays.asList(names);
                            for (int i = 0; i < list.size(); i++) 
                            {
                                pst = con.prepareStatement("select fname,fprice from fruits where fname='" + list.get(i) + "'");
                                rs = pst.executeQuery();
                                while (rs.next())
                                {
                                    %>
