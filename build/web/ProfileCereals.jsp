...
<%
    try
    {
        ...
        pst=con.prepareStatement("select * from Cereals order by Cname");
        rs=pst.executeQuery();
    }
    catch(Exception e)
    {
...
<div class="vegitables">
    <%int i=1;
    while(rs.next()){%>
    <form action="SelectedCereals.jsp" method="post">
        <div class="vimag" style="padding:10px 300px 0px 50px;">
            <img src="images/C-<%out.print(i);%>.jpg" width="180px" height="150px" id="imgid" >
        </div>
        ...
        </div><input type="checkbox" name="cerealsname" value="<%=rs.getString(1)%>" style="
      width: 28px;
      height: 28px;
      background: #fcfff4;
