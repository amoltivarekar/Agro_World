...
<%
    try {
        ...
        pst = con.prepareStatement("select * from agrouserselfinfo ");
        rs = pst.executeQuery();
			...
			<span class="menu"><img src="images/menu.png" alt=""> </span>
				<ul>
					...
					<li><a href="adminprofile.jsp">PROFILE</a></li>
                                        <li class="active"><a href="adminusers.jsp" >USERS</a></li>
    ...
    <center>
        ...
        <%while (rs.next())
        {
            ...
            <tr>
                ...
                <td>
                    <input type="submit" class="input" value="DELETE" onclick="window.location='deleteuser?user=<%=rs.getString(1)%>'" style="background: #C9A974; color:white; font-weight:bold; padding:3px 15px; border-radius: 5px;">
                </td>
            </tr>
      <%}%>
        </table>
