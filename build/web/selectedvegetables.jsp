    ...
    <body>
        ...
        <div class="header">
            ...
            <div class="vegitables">
                <center>
                    <h3 style="color: #DCC092;">YOUR SELECTED VEGETABLES ARE </h3><br><br>
                    <table width="50%">
                        <%!
                        ...
                        <%
                            ...
                            {
                                pst = con.prepareStatement("select vname,vprice from vegetables where vname='" + list.get(i) + "'");
                                rs = pst.executeQuery();
                                while (rs.next())
                                {
                                    %>
                                    <tr>
                                        ...
                                        <td style="color:white; font-weight: bold; font-size:17px;" id="a"  name="qty1" >
                                            <input type="text" class="qtyinput" value="<%out.print(""+rs.getInt(2));%>" id="a" readonly>
                                        </td>
                                        <td style="color:white; font-weight: bold; font-size:17px;">
